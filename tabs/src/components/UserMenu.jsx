...
export function UserMenu({ userInfo, openSelfService, events2Rate, events2Approve, openRating, openApproval }) {
    ...
    return (
        <Box >
            <Button className='user-menu-button'
                ...
                color="secondary"
                disableElevation
                endIcon={<Badge anchorOrigin={{
                    vertical: 'top',
                    horizontal: 'right',
                }} badgeContent={events2Rate.length + (userInfo.isNFP ? events2Approve.length : 0)} color="primary">
            ...
            >
                ...
                <Divider sx={{ my: 0.5 }} />
                {userInfo.isNFP && <MenuItem className='menu-item' disableRipple>
                    <FactCheckOutlinedIcon className='menu-icon' />
                    Approve
                </MenuItem>}
                {userInfo.isNFP && events2Approve.map((e) => (
