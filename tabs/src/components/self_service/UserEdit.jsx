...
export function UserEdit({ user }) {
  ...
  return (
    <div className="">
      {user && <Box sx={{ overflowY: 'scroll', paddingLeft: '1rem', paddingTop: '5rem', height: '100%' }}>
        <Box
          component="form"
          sx={{
          ...
          <div className="row">
                ...
                <Paper className="paper">
                  {user.Memberships.map((data) => {
                    return <Chip variant="outlined"
                      color="primary" key={data} className="chip" label={data} />;
                  })}
                </Paper>
              </div>
            )}
            ...
            {user.NFP && (
              <div>
                ...
                <Paper className="paper">
                  <Chip className="chip" variant="outlined"
                    color="primary" label={user.NFP} />
                </Paper>
              </div>
            )}
          </div>
