...
export function ConsultationList() {
    ...
    useEffect(() => {
        (async () => {
            ...
            if (consultations) {
                setOpenConsultations(consultations.filter((c) => { return !c.Closed; }));
                setReviewConsultations(consultations.filter((c) => { return c.Deadline; }));
                setFinalisedConsultations(consultations.filter((c) => { return c.Enddate; }));
            }
        ...
        <div className="">
            ...
            >
                ...
                <Box sx={{ display: 'flex', height: '85%', width: '100%' }}>
                    ...
                    <TabPanel style={{ width: '100%', height: '95%' }} value={tabsValue} index={1}>
                        <DataGrid
                    ...
                    <TabPanel style={{ width: '100%', height: '95%' }} value={tabsValue} index={2}>
                        <DataGrid
